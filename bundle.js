...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/', component: _Projects2.default })
...
/***/ function(module, exports) {
	...
	var Project_List = React.createClass({
	  ...
	  render: function render() {
	    var _this = this;
	    var createItem = function createItem(project, index) {
	      return React.createElement(
	        ...
	        React.createElement(
	          'span',
	          { onClick: _this.props.removeItem.bind(null, project['.key']),
	...
	exports.default = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Project_List, { projects: this.state.projects, removeItem: this.removeItem }),
	      React.createElement(
	        'form',
